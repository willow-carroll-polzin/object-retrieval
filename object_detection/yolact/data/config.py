from object_detection.yolact.backbone import ResNetBackbone, VGGBackbone, ResNetBackboneGN, DarkNetBackbone
...
MIT_CLASSES = open("./object_detection/yolact/data/archive/objData.txt","r").read().split("\n")
...
MIT_indoor_dataset = dataset_base.copy({
    'name':'MIT Dataset',

    'train_images': './data/archive/indoorCVPR_09/Images/',
    'train_info':   './data/archive/clean_output.json',

    'valid_images': './data/archive/indoorCVPR_09/Images/',
    'valid_info':   './data/archive/clean_output.json',
...
yolact_base_config = coco_base_config.copy({
    ...
    # Dataset stuff
    #'dataset': MIT_indoor_dataset,
    #'num_classes': len(MIT_CLASSES) + 1,
